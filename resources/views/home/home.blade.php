...
@section('content')
                ...
                <div class="col-12 col-lg-10 mx-auto">
                    <div class="position-relative" style="display: flex;flex-wrap: wrap;justify-content: flex-end;">
                        <div style="position: relative;flex: 0 0 45%;transform: translate3d(-15%, 35%, 0);"><img
                                ...
                                src="{{ asset('images/logements/servlogement.jpg') }}"></div>
                        <div style="position: relative;flex: 0 0 45%;transform: translate3d(-5%, 20%, 0);"><img
                                ...
                                src="{{ asset('images/logements/keylogement.jpg') }}"></div>
                        <div style="position: relative;flex: 0 0 60%;transform: translate3d(0, 0%, 0);"><img
                                ...
                                src="{{ asset('images/logements/logementfami.jpg') }}"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-5">
        <div class="container text-center py-5">
            <p class="mb-4" style="font-size: 1.6rem;">Le total de prix de logements est de <span
                    class="text-success"><strong>{{ number_format($montantTotal) }} Ariary</strong></span>&nbsp;dans notre
                disposition</p><a href="#"> <img class="m-3" src="assets/img/brands/google.png"></a><a
                href="#"> <img class="m-3" src="assets/img/brands/microsoft.png"></a><a href="#"> <img
                    class="m-3" src="assets/img/brands/apple.png"></a><a href="#"> <img class="m-3"
                    src="assets/img/brands/facebook.png"></a><a href="#"> <img class="m-3"
                    src="assets/img/brands/twitter.png"></a>
        </div>
    </section>
    <section>
                    ...
                    <div class="col mb-5">
                        <div class="card shadow-sm">
                            <div class="card-body px-4 py-5 px-md-5">
                                ...
                                <h5 class="fw-bold card-title">Agence&nbsp;</h5>
                                <p class="text-muted card-text mb-4">Il y a {{ $agenceCount }} Agences.</p><a
                                    href="{{ route('agence') }}" class="btn btn-primary shadow" type="button">Voir</a>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card shadow-sm">
                            <div class="card-body px-4 py-5 px-md-5">
                                ...
                                <h5 class="fw-bold card-title">Cité&nbsp;</h5>
                                <p class="text-muted card-text mb-4">Il y a {{ $citeCount }} Cités.</p><a
                                    href="{{ route('cite') }}" class="btn btn-primary shadow" type="button">Voir</a>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-4">
                        <div class="card shadow-sm">
                            <div class="card-body px-4 py-5 px-md-5">
                                ...
                                <h5 class="fw-bold card-title">Logement&nbsp;</h5>
                                <p class="text-muted card-text mb-4">Il y a {{ $logementCount }} Logements.</p><a
                                    href="{{ route('logement') }}" class="btn btn-primary shadow" type="button">Voir</a>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-4">
                            ...
                            <div class="card-body px-4 py-5 px-md-5">
                                <div class="bs-icon-lg d-flex justify-content-center align-items-center mb-3 bs-icon"
                                    style="top: 1rem;right: 1rem;position: absolute;"><svg
                                        ...
                                        fill="currentColor" viewBox="0 0 16 16" class="bi bi-chat-quote text-success">
                                        <path
                                ...
                                <h5 class="fw-bold card-title">Terrain&nbsp;</h5>
                                <p class="text-muted card-text mb-4">Il y a {{ $terrainCount }} Terrains.</p><a
                                    href="{{ route('terrain') }}" class="btn btn-primary shadow" type="button">Voir</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 d-sm-flex justify-content-sm-center">
                <div class="col mb-4">
                    <div class="d-flex flex-column align-items-center align-items-sm-start">
                        <p class="bg-dark border rounded border-dark p-4">Nisi sit justo faucibus nec ornare amet, tortor
